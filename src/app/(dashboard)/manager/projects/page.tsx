...
export const metadata: Metadata = {
  title: "Manager Projects – Taskmate Dashboard",
  description: "Manager panel to manage your projects."
};
...
export default async function ManagerProjectsPage({
  ...
  return (
    <div className="space-y-6">
      <DashboardHeader
        title="My Projects"
        subtitle="Manage and edit projects managed by you."
      >
        <AddProjectButton />
      </DashboardHeader>
      ...
      <form method="GET" className="glass-panel p-4 rounded-xl flex flex-wrap gap-4 items-end shadow-sm">
        ...
        <div className="flex gap-2">
          ...
          {(search || status || sortBy !== "createdAt" || sortOrder !== "desc") && (
            <Link href="/manager/projects" className="btn btn-outline py-1.5 px-4 text-sm h-[38px] flex items-center justify-center">
              Reset
            </Link>
          )}
        </div>
